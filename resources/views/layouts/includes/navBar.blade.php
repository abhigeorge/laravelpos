...
<a href="{{ route('users.index') }}" class="btn btn-outline rounded-pill"><i class="fa fa-money-bill"></i> Transactions</a>
<a href="{{ route('users.index') }}" class="btn btn-outline rounded-pill"><i class="fa fa-chart-bar"></i> Suppliers</a>
<a href="{{ route('users.index') }}" class="btn btn-outline rounded-pill"><i class="fa fa-users"></i> Customers</a>
<a href="{{ route('users.index') }}" class="btn btn-outline rounded-pill"><i class="fa fa-truck-moving"></i> Incoming</a>
